package com.example.simplegamenewengine;
	...
	public Scene onCreateScene() {
		...
		try {
			...
			this.runOnUiThread(new Runnable() {
				@Override
				public void run() {
					Toast.makeText(MainFile.this, "Cactus count in this TMXTiledMap: " + MainFile.this.mCactusCount, Toast.LENGTH_LONG).show();
				}
			});
